        ...
        <Flex className="gap-10 flex-wrap justify-center mt-6  h-[450px] md:bg-transparent py-5 rounded-[5px] scroll overflow-y-scroll">
         ...
         return <div key={index} >
                  <div className='w-[350px] group scale-105 group overflow-hidden relative rounded-[10px]'>
                    <Link to={title=="avada" ? "https://avada2.vercel.app/" : title=="discover" ? "https://hasan-natural.netlify.app" : title=="omah"? "https://omah2.vercel.app/" :title=="creative"? "https://thehasandev.github.io/creativeit/":title=="innovate"? "https://react-multiple-pages-website.netlify.app" :title=="charger"?"https://hasan-charger.netlify.app" : title=="daraz"? "https://daraz-ecommarce.netlify.app": title=="Orabai"? "https://ecommerce-orebi.netlify.app/" : title=="eduford"? "https://college-htmlcss.netlify.app": title=="waxom"? "https://waxxom.netlify.app" : title == "you tube" ? "https://dashing-clafoutis-ca5a45.netlify.app" : title == "sequrity" ? "https://bangel-force.netlify.app" : title == "todo" ? "https://react-facebook-todo.netlify.app" : title == "game"? "https://react-game-twoplayers.netlify.app" : title == "table search" ? "https://table-search-react.netlify.app": title == "gameFirebase"? "https://firebase-todo-murex.vercel.app/" :title == "tonix"? "https://tronix-ecommarce.netlify.app" :"/"}>
